        ...
        <div className='flex justify-between flex-wrap gap-2
          ...
          <div className='max-w-sm'>
            ...
            <Link to={'/'} className='flex-1 flex items-center justify-start'>
              ...
              <h4 className='bold-24'>Tri Thức</h4>
            </Link>
            ...
            <div className='flex items-center pl-3 h-[3rem] bg-primary w-full max-w-[333px] rounded-full ring-1 ring-slate-500/5 mb-4'>
              <input
                type="email"
                placeholder='Nhập email của bạn'
                className='bg-transparent border-none outline-none flex-grow px-2'
              />
              <button className='btn-secondaryOne px-6 py-2 rounded-full whitespace-nowrap'>
                Đặt mua
              </button>
            </div>
