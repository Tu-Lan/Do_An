...
export const FOOTER_LINKS = [
  ...
  export const FOOTER_CONTACT_INFO = {
    title: "Liên hệ",
    links: [
      { label: "Số điện thoại", value: "0879817410" },
      { label: "Địa chỉ email", value: "luuphuongvy0209@gmail.com" },
    ],
  };
  ...
  export const SOCIALS = {
    title: "Mạng xã hội",
    links: [
      { icon: <FaFacebook />, id: "facebook",url:"https://www.facebook.com/dacquyet1110" },
        { icon: <FaInstagram />, id: "instagram", url:"https://www.instagram.com/_dieplucc"},
      { icon: <FaTwitter />, id: "twitter",url:"https://twitter.com/diepluc1110" },
        { icon: <FaYoutube />, id: "youtube", url:"https://www.youtube.com/@diepluc1110" },
        { icon: <FaLinkedin />, id: "linkedin", url:"https://www.linkedin.com/in/tulan2002/" },
    ],
  };
